...
; Johto story events
	...
	const EVENT_GOT_PINK_BOW_FROM_MARY ; used in LWPath
...
; Johto hidden items
	...
	const EVENT_ROUTE_28_HIDDEN_RARE_CANDY ; used in LWPath
	const EVENT_ROUTE_30_HIDDEN_POTION ; used in LWPath
...
; Bug Catcher
	const EVENT_BEAT_YOUNGSTER_SCOTT
...
; Youngster
	...
	const EVENT_BEAT_YOUNGSTER_POLO
	const EVENT_BEAT_YOUNGSTER_ADRIAN
; Teacher
...
; Johto itemballs
	...
	const EVENT_UNION_CAVE_1F_POTION ; used in LWPath
	...
	const EVENT_ROUTE_31_POKE_BALL ; used in LWPath
...
; New to Crystal
	...
	const EVENT_ROUTE_30_ANTIDOTE ; used in LittleWater
	...
	const EVENT_RANGER_GIVE_POKEBALLS
	const EVENT_RANGER_GIVE_POTIONS
	const EVENT_GIVE_CUT
