...
; FruitTreeItems indexes (see data/items/fruit_trees.asm)
	...
	const FRUITTREE_LITTLEWATTER_1
	const FRUITTREE_LITTLEWATTER_2
	const FRUITTREE_LITTLEWATTER_3
	const FRUITTREE_LITTLEWATTER_4
	const FRUITTREE_LITTLEWATTER_5
	const FRUITTREE_LITTLEWATTER_6
