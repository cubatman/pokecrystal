...
; entries correspond to FRUITTREE_* constants
	...
	db BERRY        ;FRUITTREE_LITTLEWATTER_1
	db BERRY        ;FRUITTREE_LITTLEWATTER_2
	db PSNCUREBERRY ;FRUITTREE_LITTLEWATTER_3
	db BERRY        ;FRUITTREE_LITTLEWATTER_4
	db GRN_APRICORN ;FRUITTREE_LITTLEWATTER_5
	db PRZCUREBERRY ;FRUITTREE_LITTLEWATTER_6
