...
MapGroup_LittleWater:
	...
	map LittleWaterPath, TILESET_JOHTO, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map LittleWaterHollow, TILESET_JOHTO, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map LittleWaterField, TILESET_JOHTO, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
;	map LittleWaterFieldSouth, TILESET_JOHTO, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map LittleWaterMain, TILESET_JOHTO, TOWN, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map StartHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map LittleWaterGym, TILESET_JOHTO, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE,  PALETTE_AUTO, FISHGROUP_POND
	map GroundGymF1, TILESET_CAVE, INDOOR, LANDMARK_NEW_BARK_TOWN, MUSIC_GYM, FALSE, PALETTE_DAY, FISHGROUP_POND
	...
	map LittleWaterBurnedHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map LittleWaterBurnedHouse2, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, TRUE, PALETTE_DAY, FISHGROUP_NONE
;	assert_table_length NUM_LITTLE_WATER_MAPS

MapGroup_WanderForest:
	table_width MAP_LENGTH
	map  WanderForest, TILESET_OMANYTE_WORD_ROOM, ROUTE, LANDMARK_AZALEA_TOWN, MUSIC_BUENAS_PASSWORD, FALSE, PALETTE_DAY, FISHGROUP_POND
	map  HiddenPowerClearing, TILESET_OMANYTE_WORD_ROOM, ROUTE, LANDMARK_AZALEA_TOWN, MUSIC_BUENAS_PASSWORD, FALSE, PALETTE_DAY, FISHGROUP_POND

MapGroup_ShudderCave:
	map ShudderCaveEntrance, TILESET_CAVE, CAVE, LANDMARK_DARK_CAVE, MUSIC_NEW_BARK_TOWN, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map LittleWaterUnderBurnedHouses, TILESET_CAVE, CAVE, LANDMARK_DARK_CAVE, MUSIC_NEW_BARK_TOWN, TRUE, PALETTE_DAY, FISHGROUP_NONE
