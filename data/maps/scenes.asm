...
MapScenes::
	...
	scene_var TRADE_CENTER,                               wCianwoodCitySceneID
	scene_var TRADE_CENTER,                             wBattleTower1FSceneID
	scene_var TRADE_CENTER,                    wBattleTowerBattleRoomSceneID
	scene_var TRADE_CENTER,                       wBattleTowerElevatorSceneID
	scene_var TRADE_CENTER,                        wBattleTowerHallwaySceneID
	scene_var TRADE_CENTER,                        wBattleTowerOutsideSceneID ; unused
