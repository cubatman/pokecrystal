...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move POUND,        EFFECT_SP_ATK_DOWN_HIT,    55, DARK,         100, 15, 100 ; REPLACED with Snarl
	move KARATE_CHOP,  EFFECT_NORMAL_HIT,         50, FIGHTING,     100, 25,   0
	move DOUBLESLAP,   EFFECT_FLINCH_HIT,         25, GHOST,        100, 25,  10 ; REPLACED with Astonish
	move COMET_PUNCH,  EFFECT_MULTI_HIT,          18, FIGHTING,      90, 15,   0
	...
	move BIND,         EFFECT_ALL_UP_HIT,         60, GHOST,        100,  8,  10 ; RENAMED OMINOUS WIND 
	...
	move HEADBUTT,     EFFECT_FLINCH_HIT,         65, NORMAL,       100, 20,  30
	move HORN_ATTACK,  EFFECT_NORMAL_HIT,         65, NORMAL,       100, 25,   0
	move FURY_ATTACK,  EFFECT_MULTI_HIT,          18, NORMAL,        85, 20,   0 
	move HORN_DRILL,   EFFECT_NORMAL_HIT,         20, GROUND,        30,  5,   0 ; MADE GROUND TYPE ATTACK (WAS OHKO) ;;; MAYBE REPLACE (SAND_TOMB)
	...
	move SURF,         EFFECT_NORMAL_HIT,         65, WATER,        100, 20,   0
	...
	move RAGE,         EFFECT_ATTACK_UP_HIT,      40, DARK,         100, 20,  30 ; made dark type, 25BP
	...
	move CLAMP,        EFFECT_TRAP_TARGET,        35, STEEL,         75, 10,   0
	move SWIFT,        EFFECT_ALWAYS_HIT,         60, NORMAL,       100, 20,   0
	move SKULL_BASH,   EFFECT_SKULL_BASH,        100, NORMAL,       100, 15,   0
	move SPIKE_CANNON, EFFECT_MULTI_HIT,          20, STEEL,         85, 15,   0 ; made STEEL, 85% accuracy
	move CONSTRICT,    EFFECT_ALL_UP_HIT,         60, BUG,          100, 8,   10 ; REPLACED with SILVER WIND
	move AMNESIA,      EFFECT_SP_DEF_UP_2,         0, PSYCHIC_TYPE, 100, 20,   0
	move KINESIS,      EFFECT_SP_ATK_UP_2,         0, DARK,         100, 20,   0 ; Replaced with Nasty Plot
	...
	move BARRAGE,      EFFECT_MULTI_HIT,          20, DARK,          85, 20,   0 ; Made Dark Type, 20BP
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          40, BUG,          100, 15,   0 ; made 40BP
	move LOVELY_KISS,  EFFECT_SLEEP,               0, NORMAL,        90, 10,   0 ; made 90% accurate, maybe REPLACE
	...
	move FURY_SWIPES,  EFFECT_CONFUSE_HIT,        70, BUG,          100, 15,  10 ; REPLACED with SIGNAL BEAM
	...
	move OCTAZOOKA,    EFFECT_CONFUSE_HIT,        60, WATER,        100, 20,  20 ; Renamed WATER PULSE
	move SPIKES,       EFFECT_SPIKES,              0, GROUND,       100, 20,   0
	move ZAP_CANNON,   EFFECT_PARALYZE_HIT,      100, ELECTRIC,      50,  5, 100
	move FORESIGHT,    EFFECT_FORESIGHT,           0, NORMAL,       100, 40,   0 ; TODO: REPLACE with HAIL
	...
	move PRESENT,      EFFECT_PRESENT,             1, ICE,           90, 15,   0 ; adjusted probability, made ICE Type
	move FRUSTRATION,  EFFECT_FRUSTRATION,         1, NORMAL,       100, 20,   0 ; maybe REPLACE
	...
	move ANCIENTPOWER, EFFECT_ALL_UP_HIT,         60, ROCK,         100,  8,  10
