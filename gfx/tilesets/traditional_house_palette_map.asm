...
endr
	...
	tilepal 1, BROWN, GRAY, GRAY, RED, BROWN, BROWN, BROWN, GRAY
	tilepal 1, BROWN, BROWN, GRAY, GRAY, BROWN, BROWN, BROWN, BROWN
	tilepal 1, BROWN, BROWN, WATER, WATER, BROWN, BROWN, BROWN, GRAY
	tilepal 1, BROWN, BROWN, GRAY, GRAY, BROWN, BROWN, BROWN, BROWN
	tilepal 1, GRAY, GRAY, BROWN, BROWN, BROWN, BROWN, BROWN, TEXT
